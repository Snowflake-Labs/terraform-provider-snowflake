...
type unexportedTestHelper struct {
	AccountLevelIdentifier AccountLevelIdentifier `ddl:"identifier"`
...
func TestBuilder_parseUnexportedField(t *testing.T) {
	...
	t.Run("test unexported account object identifier", func(t *testing.T) {
		...
		s := &unexportedTestHelper{
			AccountLevelIdentifier: id,
		}
		val := reflect.ValueOf(s).Elem()
		typ := val.Type()
		value := val.FieldByName("AccountLevelIdentifier")
		field, ok := typ.FieldByName("AccountLevelIdentifier")
		require.True(t, ok)
