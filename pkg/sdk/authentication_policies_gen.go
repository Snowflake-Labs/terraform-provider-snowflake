...
type CreateAuthenticationPolicyOptions struct {
	...
	AuthenticationMethods    []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"AUTHENTICATION_METHODS"`
	MfaAuthenticationMethods []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"MFA_AUTHENTICATION_METHODS"`
	MfaEnrollment            *string                  `ddl:"parameter,single_quotes" sql:"MFA_ENROLLMENT"`
	ClientTypes              []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"CLIENT_TYPES"`
	SecurityIntegrations     []SchemaObjectIdentifier `ddl:"parameter,must_parentheses" sql:"SECURITY_INTEGRATIONS"`
...
type AuthenticationPolicySet struct {
	AuthenticationMethods    []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"AUTHENTICATION_METHODS"`
	MfaAuthenticationMethods []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"MFA_AUTHENTICATION_METHODS"`
	MfaEnrollment            []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"MFA_ENROLLMENT"`
	ClientTypes              []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"CLIENT_TYPES"`
	SecurityIntegrations     []SchemaObjectIdentifier `ddl:"parameter,parentheses" sql:"SECURITY_INTEGRATIONS"`
	Comment                  *string                  `ddl:"parameter,single_quotes" sql:"COMMENT"`
}
