...
func (s *CreatePipeRequest) WithExampleOfExternalImport(exampleOfExternalImport assert.Assertions) *CreatePipeRequest {
	s.exampleOfExternalImport = exampleOfExternalImport
	return s
}
