...
func TestInt_FileFormatsCreateAndRead(t *testing.T) {
	...
	t.Run("CSV", func(t *testing.T) {
		id := sdk.NewSchemaObjectIdentifier(databaseTest.Name, schema.Name, internal.RandomString(t))
...
func TestInt_FileFormatsAlter(t *testing.T) {
	...
	t.Run("rename", func(t *testing.T) {
		...
		oldId := fileFormat.ID()
		newId := sdk.NewSchemaObjectIdentifier(oldId.DatabaseName(), oldId.SchemaName(), internal.RandomString(t))
