...
func (v *procedures) DropSafely(ctx context.Context, id SchemaObjectIdentifierWithArguments) error {
	return SafeDrop(v.client, func() error { return v.Drop(ctx, NewDropProcedureRequest(id).WithIfExists(true)) }, ctx, id)
}
