...
func TestApiIntegration(t *testing.T) {
	...
	c.SetString(`api_provider`, `aws_private_api_gateway`)
	...
	r.Equal(`CREATE API INTEGRATION "aws_api" API_AWS_ROLE_ARN='arn:aws:iam::xxxx:role/snowflake-execute-externalfunc-privendpoint-role' API_PROVIDER='aws_private_api_gateway' API_ALLOWED_PREFIXES=('https://123456.execute-api.us-west-2.amazonaws.com/prod/', 'https://123456.execute-api.us-west-2.amazonaws.com/test/') ENABLED=true`, q)
}
