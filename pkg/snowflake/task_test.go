...
func TestTaskCreate(t *testing.T) {
	r := require.New(t)
	st := Task("test_task", "test_db", "test_schema", replace)
...
func TestTaskCreateOrReplace(t *testing.T) {
	r := require.New(t)
	st := Task("test_task", "test_db", "test_schema", true)
	r.Equal(st.Create(), `CREATE OR REPLACE TASK "test_db"."test_schema"."test_task"`)
}
