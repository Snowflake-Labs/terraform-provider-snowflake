...
func TestExternalOauthIntegrationCreate(t *testing.T) {
	...
	WithMockDb(t, func(db *sql.DB, mock sqlmock.Sqlmock) {
		mock.ExpectExec(
			`^CREATE SECURITY INTEGRATION "test_external_oauth_integration" TYPE=EXTERNAL_OAUTH EXTERNAL_OAUTH_ISSUER='https://sts.windows.net/00000000-0000-0000-0000-000000000000' EXTERNAL_OAUTH_SNOWFLAKE_USER_MAPPING_ATTRIBUTE='LOGIN_NAME' EXTERNAL_OAUTH_TYPE='AZURE' EXTERNAL_OAUTH_TOKEN_USER_MAPPING_CLAIM=\('upn'\) ENABLED=true$`,
