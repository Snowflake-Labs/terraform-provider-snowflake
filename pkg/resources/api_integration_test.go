...
func TestAPIIntegrationCreate(t *testing.T) {
	...
	in := map[string]interface{}{
		...
		"api_aws_role_arn":     "we-should-probably-validate-this-string",
	}
	...
	WithMockDb(t, func(db *sql.DB, mock sqlmock.Sqlmock) {
		mock.ExpectExec(
			`^CREATE API INTEGRATION "test_api_integration" API_AWS_ROLE_ARN='we-should-probably-validate-this-string' API_PROVIDER='aws_api_gateway' COMMENT='great comment' API_ALLOWED_PREFIXES=\('https://123456.execute-api.us-west-2.amazonaws.com/prod/'\) ENABLED=true$`,
