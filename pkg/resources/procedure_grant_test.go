...
func TestParseProcedureGrantID(t *testing.T) {
	r := require.New(t)
	grantID, err := resources.ParseProcedureGrantID("MY_DATABASE|MY_SCHEMA|MY_PROCEDURE||privilege_name|false|role1,role2|share1,share2")
	r.NoError(err)
...
func TestParseProcedureGrantIDWithArgs(t *testing.T) {
	r := require.New(t)
	grantID, err := resources.ParseProcedureGrantID("MY_DATABASE|MY_SCHEMA|MY_PROCEDURE|string,string|privilege_name|false|role1,role2|share1,share2")
	r.NoError(err)
	r.Equal("MY_DATABASE", grantID.DatabaseName)
	r.Equal("MY_SCHEMA", grantID.SchemaName)
	r.Equal("MY_PROCEDURE", grantID.ObjectName)
...
func TestParseProcedureEmojiGrantID(t *testing.T) {
	r := require.New(t)
...
func TestParseProcedureGrantIDEmojiWithArgs(t *testing.T) {
	r := require.New(t)
