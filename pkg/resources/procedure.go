...
//
//		err := client.Procedures.Alter(ctx, sdk.NewAlterProcedureRequest(id.WithoutArguments(), id.Arguments()).WithRenameTo(newId.WithoutArguments()))
//		if err != nil {
//			return diag.FromErr(err)
//		}
//
...
//		if comment != "" {
//			if err := client.Procedures.Alter(ctx, sdk.NewAlterProcedureRequest(id.WithoutArguments(), id.Arguments()).WithSetComment(comment.(string))); err != nil {
//				return diag.FromErr(err)
//			}
//		} else {
//			if err := client.Procedures.Alter(ctx, sdk.NewAlterProcedureRequest(id.WithoutArguments(), id.Arguments()).WithUnsetComment(true)); err != nil {
//				return diag.FromErr(err)
//			}
//		}
//	}
