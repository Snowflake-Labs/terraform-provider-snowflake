		...
		Steps: []resource.TestStep{
			// create with empty optionals
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("snowflake_saml2_integration.test", "saml2_snowflake_x509_cert", resources.SnowflakeDefaultStringValuePlaceholder),
					resource.TestCheckResourceAttr("snowflake_saml2_integration.test", "saml2_sign_request", "unknown"),
					resource.TestCheckResourceAttr("snowflake_saml2_integration.test", "saml2_requested_nameid_format", resources.SnowflakeDefaultStringValuePlaceholder),
					...
					resource.TestCheckResourceAttr("snowflake_saml2_integration.test", "saml2_snowflake_issuer_url", resources.SnowflakeDefaultStringValuePlaceholder),
					resource.TestCheckResourceAttr("snowflake_saml2_integration.test", "saml2_snowflake_acs_url", resources.SnowflakeDefaultStringValuePlaceholder),
		...
		Steps: []resource.TestStep{
			...
			// add config
			{
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						planchecks.PrintPlanDetails("snowflake_saml2_integration.test", "saml2_force_authn", "describe_output"),
						planchecks.ExpectChange("snowflake_saml2_integration.test", "saml2_force_authn", tfjson.ActionUpdate, sdk.String("unknown"), sdk.String("false")),
						planchecks.ExpectComputed("snowflake_saml2_integration.test", "describe_output", true),
					},
				},
				Config: saml2ConfigWithAuthn(id.Name(), issuer, string(sdk.Saml2SecurityIntegrationSaml2ProviderCustom), validUrl, cert, false),
