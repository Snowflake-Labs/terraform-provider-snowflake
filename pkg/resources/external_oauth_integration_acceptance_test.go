		...
		Steps: []resource.TestStep{
			// create with empty optionals
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("snowflake_external_oauth_integration.test", "name", id.FullyQualifiedName()),
					...
					resource.TestCheckResourceAttr("snowflake_external_oauth_integration.test", "show_output.0.name", id.FullyQualifiedName()),
			...
			// import - complete
			{
				...
				ImportStateCheck: importchecks.ComposeImportStateCheck(
					...
					importchecks.TestCheckResourceAttrInstanceState(id.Name(), "external_oauth_allowed_roles_list.0", role.ID().Name()),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "name", id.FullyQualifiedName()),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config:                   externalOauthIntegrationBasicConfig(id.Name()),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("snowflake_external_oauth_integration.test", "id", id.FullyQualifiedName()),
				),
			},
		},
	})
