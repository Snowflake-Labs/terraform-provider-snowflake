...
func TestDSN(t *testing.T) {
	...
	tests := []struct {
		...
		{"customhostignoreregion", args{"acct4", "user4", "pass4", false, "fakeregion", "role4", "zha1234.us-east-1.privatelink.snowflakecomputing.com", ""},
			"user4:pass4@zha1234.us-east-1.privatelink.snowflakecomputing.com:443?application=terraform-provider-snowflake&account=acct4&ocspFailOpen=true&role=role4&validateDefaultParameters=true", false},
	}
