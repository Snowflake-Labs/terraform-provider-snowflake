...
func (t *TaskShowOutputAssert) HasWarehouse(expected string) *TaskShowOutputAssert {
	t.AddAssertion(assert.ResourceShowOutputValueSet("warehouse", expected))
	return t
}
...
//	t.AddAssertion(assert.ResourceShowOutputValueSet("predecessors", collections.Map(expected, sdk.SchemaObjectIdentifier.FullyQualifiedName)))
//	return t
//}
