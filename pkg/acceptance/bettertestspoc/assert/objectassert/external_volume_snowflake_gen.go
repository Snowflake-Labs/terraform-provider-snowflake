...
type ExternalVolumeAssert struct {
	*assert.SnowflakeObjectAssert[sdk.ExternalVolume, sdk.ExternalVolumeObjectIdentifier]
}

func ExternalVolume(t *testing.T, id sdk.ExternalVolumeObjectIdentifier) *ExternalVolumeAssert {
	t.Helper()
