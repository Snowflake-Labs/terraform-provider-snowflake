...
test-account-level-features: ## run integration and acceptance test modifying account
	TF_ACC=1 TEST_SF_TF_REQUIRE_TEST_OBJECT_SUFFIX=1 TEST_SF_TF_REQUIRE_GENERATED_RANDOM_VALUE=1 SF_TF_ACC_TEST_ENABLE_ALL_PREVIEW_FEATURES=true go test -p=1 --tags=account_level_tests -run "^(TestAcc_|TestInt_)" -v -cover -timeout=150m ./pkg/testacc ./pkg/sdk/testint $(ADDITIONAL_TEST_FLAGS)
...
SHOW_OUTPUT_SCHEMAS_EXCLUDE ?= sdk.AuthenticationPolicy,sdk.CatalogIntegrationAwsGlueDetails,sdk.CatalogIntegrationObjectStorageDetails,sdk.ComputePool,sdk.Connection,sdk.Database,sdk.DynamicTable,sdk.Function,sdk.GitRepository,sdk.HybridTableConstraint,sdk.IcebergTable,sdk.Listing,sdk.ManagedAccount,sdk.MaskingPolicy,sdk.MaterializedView,sdk.Notebook,sdk.OpenflowConnectorDefinition,sdk.OpenflowRuntime,sdk.PolicyReference,sdk.PostgresInstance,sdk.Procedure,sdk.ProgrammaticAccessToken,sdk.ReplicationAccount,sdk.ResourceMonitor,sdk.Schema,sdk.Secret,sdk.Service,sdk.SessionPolicy,sdk.SessionPolicyDetails,sdk.Share,sdk.Stage,sdk.StorageIntegrationAllDetails,sdk.StorageIntegrationAwsDetails,sdk.StorageIntegrationAzureDetails,sdk.StorageIntegrationGcsDetails,sdk.Stream,sdk.Table,sdk.Tag,sdk.Task,sdk.Warehouse
