...
- `privilege` (String) The account privilege to grant. Valid priviliges are those in [globalPriviliges](https://docs.snowflake.com/en/sql-reference/sql/grant-privilege.html)
