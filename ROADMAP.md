...
- Keep in mind that V1 does not mean we have an official Snowflake support (check our new disclaimer [here](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/latest/docs)).
